...
download_udpServer(){
	...
	if wget -O /usr/bin/udpServer 'https://raw.githubusercontent.com/adiel-dev/ramirez/main/udpServer' &>/dev/null ; then
...
menu_udp(){
	title "${a1:-SCRIPT DE CONFIGRACION UDPserver} Netfree Mx"
	print_center -ama 'script'
	print_center -ama 'telcel'
	msg -bar
